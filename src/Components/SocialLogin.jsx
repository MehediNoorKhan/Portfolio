  ...
  return (
    <div className="w-full mt-4">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2 border border-gray-300 rounded-md bg-white hover:bg-gray-100 transition duration-200"
      >
        <svg
